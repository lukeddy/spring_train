package bean;
public class TbsMenuBean extends BaseBean {
    ...
    private java.util.List<TbsMenuBean> childs = new java.util.ArrayList<TbsMenuBean>();

	public java.util.List<TbsMenuBean> getChilds() {
		return childs;
	}
	public void setChilds(java.util.List<TbsMenuBean> childs) {
		this.childs = childs;
	}
}
